...
In R, points falling outside the whiskers of the boxplot are referred to as _outliers_. This definition of outlier was introduced by Tukey. The top whisker ends at the 75th percentile plus 1.5 × IQR. Similarly the bottom whisker ends at the 25th percentile minus 1.5 × IQR. If we define the first and third quartiles as $Q_1$ and $Q_3$ respectively, then an outlier is anything outside the range:
$$
...
The first seven entries look like strange errors. However, the next few look like they were entered as centimeters instead of inches. Since 184cm is equivalent to six feet tall, we suspect that 184 was actually meant to be 72 inches.
